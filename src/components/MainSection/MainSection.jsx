    ...
    <div className={style.mainDiv}>
      ...
      <div className={style.insideDiv}>
       ...
       <div className={style.divChild}>
          ...
          <Link to = {'/'}  onClick={()=>{ scrollToTop();scrollToSection(`login`)}}><Button variant="contained"  sx={{fontWeight:'bold',color:'white',width:'140px',backgroundColor:' rgb(0, 51, 102);'}} >Click here</Button>
          </Link>
        </div>
